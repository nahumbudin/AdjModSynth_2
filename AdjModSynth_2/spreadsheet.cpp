...
//	}
	...
	table->setHorizontalHeaderItem(0, new QTableWidgetItem("Chan"));
	table->setHorizontalHeaderItem(1, new QTableWidgetItem("Bank"));
	table->setHorizontalHeaderItem(2, new QTableWidgetItem("Prog"));
	table->setHorizontalHeaderItem(3, new QTableWidgetItem("Name"));
	table->setHorizontalHeaderItem(4, new QTableWidgetItem("SFID"));
	table->setHorizontalHeaderItem(5, new QTableWidgetItem("SoundFont"));
	...
	QString character(QChar(' '));
	for (int i = 0; i < table->rowCount(); i++)
	{
		table->setRowHeight(i, 20);
		table->setVerticalHeaderItem(i, new QTableWidgetItem(""));
		table->setItem(i, 0, new SpreadSheetItem(QString::number(i+1)));
	}
...
/*
	// column 0
	table->setItem(0, 0, new SpreadSheetItem("Chan"));
...
/*
	// column 1
	table->setItem(0, 1, new SpreadSheetItem("Bank"));
...
/*
	// column 2
	table->setItem(0, 2, new SpreadSheetItem("Prog"));
...
/*
	// column 3
	table->setItem(0, 3, new SpreadSheetItem("Name"));
...
/*
	// column 4
	table->setItem(0, 4, new SpreadSheetItem("SFID"));
...
/*
	// column 5
	table->setItem(0, 5, new SpreadSheetItem("SoundFont"));
